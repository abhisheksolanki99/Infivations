...
jQuery(document).ready(function($) {
		...
		$("ul.colors .color1" ).click(function(){
			$("#color" ).attr("href", "lib/css/colors/default.css" );
			return false;
		});
		
		$("ul.colors .color2" ).click(function(){
			$("#color" ).attr("href", "lib/css/colors/orange.css" );
			return false;
		});
		
		$("ul.colors .color3" ).click(function(){
			$("#color" ).attr("href", "lib/css/colors/alizarin.css" );
			return false;
		});

		$("ul.colors .color4" ).click(function(){
			$("#color" ).attr("href", "lib/css/colors/emerald.css" );
			return false;
		});

		$("ul.colors .color5" ).click(function(){
			$("#color" ).attr("href", "lib/css/colors/green-see.css" );
			return false;
		});
		
		$("ul.colors .color6" ).click(function(){
			$("#color" ).attr("href", "lib/css/colors/peter-river.css" );
			return false;
		});

		$("ul.colors .color7" ).click(function(){
			$("#color" ).attr("href", "lib/css/colors/turquoise.css" );
			return false;
		});
		$("ul.colors .color8" ).click(function(){
			$("#color" ).attr("href", "lib/css/colors/sun-flower.css" );
			return false;
		});
